...
Z.prop.test <- function(p1, p0, n1, p2=NULL, n2=NULL) { 
  ...
  return (list(p.value = as.numeric(p), z, lower, upper)) } 
...
ggplot(data = d, aes(x = Brain_Size_Species_Mean, y = MaxLongevity_m)) + geom_point(color="darkorange3") + 
  ...
  geom_line(aes(x = d$Brain_Size_Species_Mean, y = lines$upr, color = "purple")) + scale_fill_manual(values=c("orange", "black", "purple")) + scale_color_manual(values=c("orange", "black", "purple")) + scale_color_discrete(name = "legend", labels = c("Fit", "Lower", "Upper"))
...
ggplot(data = d, aes(x = log(Brain_Size_Species_Mean), y = log(MaxLongevity_m))) + geom_point(color="darkorange") + geom_text(aes(x = 4, y = 7, label=text)) + 
  ...
  geom_line(aes(x = log(d$Brain_Size_Species_Mean), y = log(lines2$upr)), colour = "darkorchid4") + scale_color_manual(name = "Lines", values = c("Fit" = "black", "Lower" = "orange", "Upper" = "darkorchid4"))
